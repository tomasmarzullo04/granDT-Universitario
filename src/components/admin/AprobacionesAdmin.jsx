...
export default function AprobacionesAdmin() {
  ...
  const sendWelcomeEmail = async (userEmail, userName) => {
    try {
      // Plantilla HTML para el correo de bienvenida.
      const htmlTemplate = `
      ...
      // El envío real (y la API key de Resend) viven en la Edge Function "send-email".
      // Mientras el dominio de Resend no esté verificado, solo llega al email del dueño
      // de la cuenta Resend (limitación del proveedor, no de este código).
      ...
      console.log('✅ Email solicitado vía Edge Function:', data?.id ?? userEmail);
    } catch (err) {
